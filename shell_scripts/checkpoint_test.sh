...
python train_WGAN_GP.py --fresh_start --dataset_subset_percentage 0.01 --epochs 5
...
python train_WGAN_GP.py --reload_last_trained_model --dataset_subset_percentage 0.01 --epochs 5
